const userData = {
  githubUsername: "csaragon1941",
  name: "Christina Aragon",
  designation: "Certified SAFe® 5 Product Owner/ Product Manager",
  avatarUrl: "/C.Aragon-Avatar.jpg",
  email: "aragonchristina2@gmail.com",
  phone: "+1 305-282-4155",
  address: "Naples, Florida, U.S.A",
  projects: [
    {
  ...
  experience: [
    ...
    },
    {
      ...
      year: "2023",
      companyLink: "",
      desc: "Helped in the development of an important goverment program that provides users with a rapid way to obtain their benefits.",
    },
    {
      title: " College Graduation",
      company: "Florida Gulf Coast University",
      year: "2023",
      companyLink: "https://www.fgcu.edu/",
      desc: "Apart from being involved, I worked hard in acheiving my undergraduate in Software Engineering!",
    },
    {
      title: "High School",
      company: "Westminster Christian School",
      year: "2018",
      companyLink: "https://www.wcsmiami.org/",
      desc: "Straight out of my hometown Miami, FL.I took courses pertaining to Engineering that gave me experience with AutoCAD.",
    },
  ],
  resumeUrl:
